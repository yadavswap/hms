                                        ...
                                        @if (count($bedType->beds) > 0)
                                            @foreach ($bedType->beds as $bed)
                                                <div class="col-lg-2 col-md-3 col-6 text-center py-4">
                                                    @if (
                                                        !$bed->bedAssigns->isEmpty() &&
                                                            !$bed->is_available &&
                                                            ($bed->bedAssigns[0]->discharge_date == null ||
                                                                $bed->bedAssigns[0]->discharge_date > \Carbon\Carbon::now()->format('Y-m-d H:i:s')))
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="py-1">
                                                                    <label
                                                                        ...
                                                                        :</label>
                                                                    <span
                                                                        class="fs-6 text-gray-600">{{ $bed->bedAssigns[0]->patient->patientUser->full_name }}</span>
                                                                </div>
                                                                <div class="py-1">
                                                                    <label
                                                                        ...
                                                                        :</label>
                                                                    <span
                                                                        class="fs-6 text-gray-600">{{ !empty($bed->bedAssigns[0]->patient->patientUser->phone) ? $bed->bedAssigns[0]->patient->patientUser->phone : __('messages.common.n/a') }}</span>
                                                                </div>
                                                                <div class="py-1">
                                                                    <label
                                                                ...
                                                                <div class="py-1">
                                                                    <label
                                                                        ...
                                                                        :</label>
                                                                    <span
                                                                        class="fs-6 text-gray-600">{{ $bed->bedAssigns[0]->patient->patientUser->gender === 0 ? 'Male' : 'Female' }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="pt-1">
