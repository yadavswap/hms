                    ...
                    <div class="card-body  border-top p-9">
                        <div class="row mb-7">
                            <div class="col-lg-4 d-flex flex-column">
                                ...
                                <span
                                    class="fw-bolder fs-6 text-gray-800">{{ $deathReport->patient->user->full_name }}</span>
                            </div>
                            <div class="col-lg-4 d-flex flex-column">
                                <label
                            ...
                            <div class="col-lg-4 d-flex flex-column">
                                ...
                                <span
                                    class="fw-bolder fs-6 text-gray-800">{{ $deathReport->doctor->user->full_name }}</span>
                            </div>
                            <div class="col-lg-4 d-flex flex-column">
                                <label
                                    class="fw-bold text-muted py-3">{{ __('messages.death_report.date') . ':' }}</label>
                                <span
                                    class="fw-bolder fs-6 text-gray-800">{{ \Carbon\Carbon::parse($deathReport->date)->format('jS M, Y g:i A') }}</span>
                            </div>
                            <div class="col-lg-4 d-flex flex-column">
                                <label
                                    class="fw-bold text-muted py-3">{{ __('messages.death_report.description') . ':' }}</label>
                                <span class="fw-bolder fs-6 text-gray-800">{!! !empty($deathReport->description) ? nl2br(e($deathReport->description)) : __('messages.common.n/a') !!}</span>
                            </div>
                            <div class="col-lg-4 d-flex flex-column">
                                <label
