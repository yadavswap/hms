                                ...
                                <a class="text-decoration-none" href="{{ route('invoices.index') }}">
                                    <div
                                        ...
                                        <div class="text-end text-white">
                                            ...
                                            <h3 class="mb-0 fs-5 fw-light">{{ __('messages.dashboard.total_invoices') }}
                                            </h3>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a href="{{ route('payments.index') }}" class="text-decoration-none">
                                    <div
                                        ...
                                        <div class="text-end text-white">
                                            ...
                                            <h3 class="mb-0 fs-5 fw-light">{{ __('messages.dashboard.total_payments') }}
                                            </h3>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a href="{{ route('beds.index') }}" class="text-decoration-none">
                                    <div
                                        ...
                                        <div class="text-end text-white">
                                            ...
                                            <h3 class="mb-0 fs-5 fw-light">{{ __('messages.dashboard.available_beds') }}
                                            </h3>
                                        </div>
                                    </div>
                                </a>
                    ...
                    @if ($modules['Admin'] == true)
                        ...
                        <div class="widget">
                            <a href="{{ route('admins.index') }}" class="text-decoration-none">
                                <div
                                    class="bg-purple shadow-md rounded-10 p-xxl-10  px-5 py-10 d-flex align-items-center justify-content-between mb-sm-3 mb-2">
                                    <div
                    ...
                    @if ($modules['Accountants'] == true)
                        ...
                        <div class="widget">
                            <a href="{{ route('accountants.index') }}" class="text-decoration-none">
                                <div
                                    class="bg-blue shadow-md rounded-10 p-xxl-10 px-5 py-10 d-flex align-items-center justify-content-between my-sm-3 my-2">
                                    <div
                                        class="bg-blue-700 widget-icon rounded-10 d-flex align-items-center justify-content-center">
                    ...
                    @if ($modules['Lab Technicians'] == true)
                        ...
                        <div class="widget">
                            <a href="{{ route('lab-technicians.index') }}" class="text-decoration-none">
                                <div
                                    class="bg-pink shadow-md rounded-10 p-xxl-10 px-5 py-10 d-flex align-items-center justify-content-between my-sm-3 my-2">
                                    <div
                                        class="bg-pink-700 widget-icon rounded-10 d-flex align-items-center justify-content-center">
                    ...
                    @if ($modules['Pharmacists'] == true)
                        ...
                        <div class="widget">
                            <a href="{{ route('pharmacists.index') }}" class="text-decoration-none">
                                <div
                                    class="bg-darkgreen shadow-md rounded-10 p-xxl-10 px-5 py-10 d-flex align-items-center justify-content-between my-sm-3 my-2">
                                    <div
                                        class="bg-darkgreen-700 widget-icon rounded-10 d-flex align-items-center justify-content-center">
                    ...
                    @if ($modules['Receptionists'] == true)
                        ...
                        <div class="widget">
                            <a href="{{ route('receptionists.index') }}" class="text-decoration-none">
                                <div
                                    class="bg-orange shadow-md rounded-10 p-xxl-10 px-5 py-10 d-flex align-items-center justify-content-between my-sm-3 my-2">
                                    <div
                                        class="bg-orange-700 widget-icon rounded-10 d-flex align-items-center justify-content-center">
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="text-center">{{ __('messages.common.created_on') }}
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody class="text-gray-600 fw-bold">
